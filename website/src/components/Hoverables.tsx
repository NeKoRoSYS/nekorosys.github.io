...
export function HoverCard({ children, _className, animate }: CardProps) {
    return (
        <PopoutBlock animate={animate} className={`${_className} flex-1 ${ Animations.riseOnHover } transition-transform`}>
            {children}
        </PopoutBlock>
    )
}
