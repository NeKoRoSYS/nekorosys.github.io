  ...
  return (
    <PageWrapper>
        <div className="flex flex-col w-full items-center animate-in fade-in duration-700 mt-32 mb-15 gap-10">
            ...
            <FadeIn delay={0.2}>
                <h1 className='text-3xl font-extrabold text-white tracking-tight drop-shadow-[0_0_20px_rgba(255,255,255,0.5)]'>My Tech Stack</h1>
            </FadeIn>

            <div className="flex flex-col md:flex-row gap-8 max-w-6xl px-4 mb-50">
                <PopoutBlock className={`flex-1 ${ Colors.riseOnHover } transition-transform`}>
            ...
            <div className="flex flex-col gap-8 w-full px-4">
                ...
                <div className="flex items-center gap-3 mb-4">
                    <h3 className="font-bold text-xl text-white">My Projects</h3>
                </div>
                <div className="space-y-2 text-sm text-gray-300">
                </div>
                </PopoutPanel>
